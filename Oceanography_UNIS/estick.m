function estick(tt,x,y,tlen,units,labels)
% ESTICK        modified STICKPLOT from the oceans toolbox
%
% estick(tt,x,y,tlen,units,labels)
%
...
%                                                       Even
%
%Time-stamp:<Last updated on 00/12/06 at 14:51:52 by even@gfi.uib.no>
%File:<d:/home/matlab/estick.m>
