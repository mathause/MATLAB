...
% for the current day using the harmonics file from XTIDE. Predictions
% at other times can be generated using [...]=T_XTIDE(STATION,TIM)
% where TIM is a vector of matlab-format decimal days (from DATENUM). 
% If TIM is a scalar then it is taken as the number of days from present
