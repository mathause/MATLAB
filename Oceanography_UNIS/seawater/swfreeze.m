function TF=swfreezetemp(S,P);

% Part of the staplot package. For instructions, see sta_info.m.
%
% from: Oceanography toolbox  v1.4 (WHOI)
%        - R. Pawlowicz 14/Mar/94 (rich@boreas.whoi.edu)

% SWFREEZETEMP Computes the freezing point of seawater
%              TEMP=SWFREEZETEMP(S,P) is the freezing point (deg C)
