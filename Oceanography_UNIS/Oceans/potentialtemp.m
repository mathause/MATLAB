function THETA=potentialtemp(S,T0,P0,PR);
% POTENTIALTEMP Potential temperature from in-situ measurements.
%          THETA=POTENTIALTEMP(S,TO,PO,PR) computes the potential temp.
...
%
% This routine calls adiabattempgrad.m (renamed from ATG).
